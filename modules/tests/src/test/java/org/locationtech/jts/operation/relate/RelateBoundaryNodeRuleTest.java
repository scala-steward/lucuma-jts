    ...
    extends TestCase
{
      ...
      throws Exception
  {
    ...
    runRelateTest(a, b, BoundaryNodeRule$.MODULE$.ENDPOINT_BOUNDARY_RULE(),  "FF1F00102"    );
  }
      ...
      throws Exception
  {
    ...
    runRelateTest(a, b,  BoundaryNodeRule$.MODULE$.OGC_SFS_BOUNDARY_RULE(),   "F01FF0102"    );
    runRelateTest(a, b,  BoundaryNodeRule$.MODULE$.ENDPOINT_BOUNDARY_RULE(),  "F01FF0102"    );
  }
...
//    runRelateTest(a, b,  BoundaryNodeRule.ENDPOINT_BOUNDARY_RULE,  "FF1F0F102"    );
    // under MultiValent, A has a boundary node but B does not - A.bdy / B.bdy = F and A.int
    runRelateTest(a, b,  BoundaryNodeRule$.MODULE$.MULTIVALENT_ENDPOINT_BOUNDARY_RULE(),  "0F1FFF1F2"    );
  }
      ...
      throws Exception
  {
    ...
    runRelateTest(a, b,  BoundaryNodeRule$.MODULE$.OGC_SFS_BOUNDARY_RULE(),   "F01FFF102"    );
      ...
      throws ParseException
  {
    ...
    IntersectionMatrix im = RelateOp$.MODULE$.relate(g1, g2, bnRule);
